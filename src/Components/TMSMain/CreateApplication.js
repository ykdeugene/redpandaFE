...
function CreateApplication({ fetchApplication }) {
    ...
    if (validation) {
      try {
        ...
        if (response.data.result === "true") {
          ...
          Offcanvas.getInstance(document.getElementById("createAppFormOC")).hide()
  ...
  return (
    <>
        ...
        <div className="input-group mb-2" style={{ height: "5vh", width: "90vh" }}>
          ...
          {!Boolean(!App_Acronym && !App_Rnumber) ? (
            ...
            <button
              ...
              type="button"
              onClick={() => {
                new Offcanvas("#createAppFormOC").show()
              }}
            >
              Create App
            </button>
      ...
      <div className="offcanvas offcanvas-start" data-bs-backdrop="static" id="createAppFormOC" style={{ width: "70vh" }}>
        ...
        <div className="offcanvas-body pt-0">
          ...
          <form id="createAppplicationForm">
            ...
            <button onClick={handleSubmitCreateApplication} type="button" className="btn btn-primary mt-3">
              Create
            </button>
          </form>
        </div>
